...
import rain.core.future.CloseFuture;
import rain.core.future.DefaultCloseFuture;
import rain.core.future.DefaultReadFuture;
import rain.core.future.DefaultWriteFuture;
import rain.core.future.IoFutureListener;
import rain.core.future.ReadFuture;
...
import rain.core.write.WriteException;
import rain.core.write.WriteRequest;
import rain.core.write.WriteTimeoutException;
...
public abstract class AbstractIoSession implements IoSession {
    ...
    private DefaultWriteRequestQueue writeRequestQueue;
     ...
     */
    public final void setWriteRequestQueue(DefaultWriteRequestQueue writeRequestQueue) {
     ...
     * {@inheritDoc}
     */
    public final DefaultWriteRequestQueue getWriteRequestQueue() {
        if (writeRequestQueue == null) {
    ...
    /**
     * {@inheritDoc}    This is a ridiculous implementation. Need to be
     * replaced.
     */
    @Override
