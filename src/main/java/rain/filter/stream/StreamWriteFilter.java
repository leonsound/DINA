 ...
 * call {@link rain.core.filterchain.IoFilter.NextFilter#messageSent(rain.core.session.IoSession, rain.core.write.WriteRequest)} using the original
 * {@link InputStream} written to the session and notifies
 * {@link rain.core.future.WriteFuture} on the
 * original {@link rain.core.write.WriteRequest}.
 * <p>
 ...
 * has been written. The {@link rain.core.service.IoHandler} should take
 * care of that in its
 * {@link rain.core.service.IoHandler#messageSent(IoSession,Object)}
 * callback.
 *
