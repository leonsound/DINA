...
public class SingleSessionIoHandlerDelegate implements IoHandler {
    ...
    /**
     * @return the {@link SingleSessionIoHandlerFactory} that is used to create a new
     ...
     * 
     * @see rain.core.service.IoHandler#sessionCreated(rain.core.session.IoSession)
     */
    @Override
