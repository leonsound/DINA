...
import rain.core.service.AbstractIoConnector;
...
import rain.proxy.session.ProxyIoSessionInitializer;
import rain.transport.socket.DefaultSocketSessionConfig;
import rain.transport.socket.SocketConnector;
...
public class ProxyConnector extends AbstractIoConnector {
    private static final TransportMetadata METADATA = new DefaultTransportMetadata("proxy", "proxyconnector", false,
            true, InetSocketAddress.class, SocketSessionConfig.class, IoBuffer.class);
