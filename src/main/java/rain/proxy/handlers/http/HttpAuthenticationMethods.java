 ...
 *
 */
package rain.proxy.handlers.http;

import rain.proxy.ProxyAuthException;
import rain.proxy.handlers.http.basic.HttpBasicAuthLogicHandler;
import rain.proxy.handlers.http.basic.HttpNoAuthLogicHandler;
import rain.proxy.handlers.http.digest.HttpDigestAuthLogicHandler;
import rain.proxy.handlers.http.ntlm.HttpNTLMAuthLogicHandler;
