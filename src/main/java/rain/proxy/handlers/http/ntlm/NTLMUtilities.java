...
import rain.proxy.utils.ByteUtilities;
...
public class NTLMUtilities implements NTLMConstants {
    ...
    public static final byte[] getOsVersion() {
        ...
        try {
            ...
            try {
                ...
                writeOSVersion(Byte.parseByte(version.substring(0, 1)), Byte.parseByte(version.substring(2, 3)),
                        (short) 0, osVer, 0);
            } catch (Exception ex2) {
                return DEFAULT_OS_VERSION;
            }
    ...
    public static final byte[] createType1Message(String workStation, String domain, Integer customFlags,
        ...
        int flags = customFlags != null ? customFlags | FLAG_NEGOTIATE_WORKSTATION_SUPPLIED
    ...
    public static final byte[] createType3Message(String user, String password, byte[] challenge, String target,
        ...
        try {
            ...
            boolean useUnicode = ByteUtilities.isFlagSet(flags, FLAG_NEGOTIATE_UNICODE);
